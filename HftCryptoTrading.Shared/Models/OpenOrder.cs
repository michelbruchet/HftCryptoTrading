...
public class OpenOrder(string symbol, string exchange)
{
    ...
    /// <summary>
    /// The order id generated by Exchange
    /// </summary>
    ...
    public void Update(OrderUpdate position)
    {
        Price = position.Price;
        QuantityFilled = position.QuantityFilled;
        QuoteQuantityFilled = position.QuoteQuantityFilled;
        Status = position.Status;
        TimeInForce = (int)position.TimeInForce;
        UpdateTime = position.UpdateTime;
        IsWorking = position.IsWorking;
    }
}
